...
(function (root) {
  ...
  root.CET_LANG_FR = {
    ...
    "app.auth.error.netdirect":"Erreur réseau. Vérifie ta connexion et réessaie.",
    "app.auth.error.taken":    "Cet email a déjà un compte.",
    "app.auth.error.throttled":"Trop d'essais depuis ici. Réessaie dans une heure.",
    ...
    "html.settings.eur.label":    "Taux $ vers €",
