...
(function (root) {
  ...
  root.CET_LANG_EN = {
    ...
    "app.auth.error.netdirect":"Network error. Check your connection and try again.",
    "app.auth.error.taken":    "This email already has an account.",
    "app.auth.error.throttled":"Too many attempts from here. Try again in an hour.",
