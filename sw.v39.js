/* Service worker v39 — Claude Eats Tokens.
   Stratégie : network-first sur l'app-shell (toujours la dernière version),
   network-ONLY sur les données (usage.json, Render). Purge tout cache != v39 à
   ...
   v39 : deux fixes i18n révélés en préparant les assets de lancement. Fin du
   doublon "resets resets in ..." en anglais dans la carte fenêtres (until()
   renvoie déjà la phrase complète), et marqueur du spectre "Où je me situe"
   traduit ("You" au lieu de "Toi" codé en dur) via la clé app.pos.you.
   Invalide v38. */
const CACHE = "cet-v39";
const ASSETS = [
