/* Service worker v35 — Claude Eats Tokens.
   Stratégie : network-first sur l'app-shell (toujours la dernière version),
   network-ONLY sur les données (usage.json, Render). Purge tout cache != v35 à
   ...
   v35 : prompt notifications post-connexion + dark mode hero + 3 nouvelles clés
   i18n (html.notif.prompt.*). */
const CACHE = "cet-v35";
const ASSETS = [
