/* Service worker v33 — Claude Eats Tokens.
   Stratégie : network-first sur l'app-shell (toujours la dernière version),
   network-ONLY sur les données (usage.json, Render). Purge tout cache != v33 à
   ...
   v33 : internationalisation (i18n EN/FR) — ajout des 3 fichiers i18n dans le
   cache ASSETS. Aucun changement de stratégie de cache. */
const CACHE = "cet-v33";
const ASSETS = [
