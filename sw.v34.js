/* Service worker v34 — Claude Eats Tokens.
   Stratégie : network-first sur l'app-shell (toujours la dernière version),
   network-ONLY sur les données (usage.json, Render). Purge tout cache != v34 à
   ...
   v34 : ajout aurora.js + tokens-field.js dans ASSETS (shaders WebGL cachés
   hors-ligne) + wake-bar + moment aha + badge démo renforcé + vlight 80px. */
const CACHE = "cet-v34";
const ASSETS = [
